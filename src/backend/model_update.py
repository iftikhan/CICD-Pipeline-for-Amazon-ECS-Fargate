...
class Merchant_product_details_update(BaseModel):
    active :Optional[int]
...
class giftcard_attribute_values_update(BaseModel):
...
class merchant_product_orders_update(BaseModel):
...
class brand_categories_update(BaseModel):
    version: Optional[int]
...
class brand_category_transaction_categories_update(BaseModel):
    version : Optional[int]
...
class user_order_details_update(BaseModel):
    version : Optional[int]
...
class merchant_product_detail_variant_values_update(BaseModel):
...
class brand_images_update(BaseModel):
...
class giftcard_batches_update(BaseModel):
    version : Optional[int]
...
class giftcard_variety_brands_update(BaseModel):
    version : Optional[int]
    giftcard_variety_id : Optional[int]
    brand_id : Optional[ObjectId]
...
class merchant_product_order_details_update(BaseModel):
    version : Optional[int]
    order_details_status : Optional[str]
...
class experience_order_details_update(BaseModel):
...
class homepage_banners_update(BaseModel):
    version : Optional[int]
    active : Optional[bool]
    banner : Optional[str]
...
class point_transactions_update(BaseModel):
    version : Optional[int]
...
class offer_campaign_images_update(BaseModel):
...
class giftcard_units_update(BaseModel):
    version : Optional[int]
...
class merchant_product_categories_update(BaseModel):
    active : Optional[bool]
...
class offer_campaigns_update(BaseModel):
    version : Optional[int]
    active : Optional[bool]
...
class openid_providers_update(BaseModel):
    version : Optional[int]
...
class wallet_giftcards_update(BaseModel):
    version : Optional[int]
...
class delivery_methods_update(BaseModel):
    version : Optional[int]
...
class supplier_accounts_update(BaseModel):
    version : Optional[int]
    active : Optional[bool]
...
class merchant_product_images_update(BaseModel):
    merchant_product_id : Optional[ObjectId]
    image : Optional[str]
...
class wallets_update(BaseModel):
    version : Optional[int]
...
class whitelisted_proxies_update(BaseModel):
    version : Optional[int]
    active : Optional[bool]
...
class third_party_brands_update(BaseModel):
    version : Optional[int]
    active : Optional[bool]
...
class giftcard_types_update(BaseModel):
    version : Optional[int]
...
class experience_orders_update(BaseModel):
    user_id : Optional[ObjectId]
    order_status : Optional[str]
    order_total : Optional[float]
    orderid : Optional[str]
...
class suppliers_update(BaseModel):
    version : Optional[int]
...
class supplier_access_logs_update(BaseModel):
    version : Optional[int]
...
class offer_campaign_categories_update(BaseModel):
    active : Optional[bool]
    offer_campaign_id : Optional[ObjectId]
...
class giftcards_update(BaseModel):
    version : Optional[int]
...
class giftcard_terms_update(BaseModel):
    version: Optional[int]
    giftcard_variety_id : Optional[int]
...
class experience_details_update(BaseModel):
    giftcard_variety_id : Optional[ObjectId]
...
class experience_slots_update(BaseModel):
    active : Optional[bool]
    giftcard_variety_id : Optional[ObjectId]
...
class experience_order_recipients_update(BaseModel):
    name : Optional[str]
    email : Optional[str]
...
class giftcard_styles_update(BaseModel):
    version : Optional[int]
...
class experience_images_update(BaseModel):
    active : Optional[bool]
    image : Optional[str]
    default_image_flag : Optional[bool]
...
class variants_update(BaseModel):
    active : Optional[bool]
...
class user_phones_update(BaseModel):
    version : Optional[int]
    active : Optional[bool]
    user_id : Optional[ObjectId]
    phone : Optional[str]
...
class giftcard_attributes_update(BaseModel):
    version : Optional[int]
...
class experience_prices_update(BaseModel):
    active : Optional[bool]
    giftcard_variety_id : Optional[bool]
...
class offer_campaign_terms_update(BaseModel):
    offer_campaign_id : Optional[ObjectId]
    terms_text :Optional[str]
    language : Optional[str]
...
class interface_methods_update(BaseModel):
    version : Optional[int]
...
class merchant_product_transaction_categories_update(BaseModel):
    active : Optional[bool]
    merchant_product_id : Optional[ObjectId]
    transaction_category_id : Optional[ObjectId]
...
class giftcard_denominations_update(BaseModel):
    version : Optional[int]
...
class merchant_product_variants_update(BaseModel):
    active : Optional[bool]
    merchant_product_id : Optional[ObjectId]
...
class user_order_details_giftcards_update(BaseModel):
    version : Optional[int]
...
class user_addresses_update(BaseModel):
    version : Optional[int]
    active : Optional[bool]
    user_id : Optional[ObjectId]
...
class countries_update(BaseModel):
...
class categories_update(BaseModel):
    version : Optional[int]
...
class redemption_partners_update(BaseModel):
    version : Optional[int]
    active : Optional[bool]
...
class user_openids_update(BaseModel):
    version : Optional[int]
    user_id : Optional[ObjectId]
    provider_id : Optional[ObjectId]
    provider_uid : Optional[str]
...
class transaction_categories_update(BaseModel):
    version : Optional[int]
    category_name : Optional[str]
    active : Optional[bool]
...
class giftcard_variety_denominations_update(BaseModel):
    version : Optional[int]
    active : Optional[bool]
    giftcard_variety_id : Optional[ObjectId]
...
class giftcard_details_update(BaseModel):
    version : Optional[int]
    giftcard_id : Optional[ObjectId]
    giftcard_variety_id : Optional[ObjectId]
...
class third_party_order_details_update(BaseModel):
    delivery_method_id : Optional[ObjectId]
...
class user_orders_update(BaseModel):
    version : Optional[int]
    order_status : Optional[str]
    user_id : Optional[ObjectId]
    payment_method_id : Optional[ObjectId]
...
class offer_order_details_update(BaseModel):
    version : Optional[int]
    order_details_status: Optional[str]
    offer_order_id : Optional[ObjectId]
    offer_campaign_id : Optional[ObjectId]
...
class giftcard_batch_giftcard_details_update(BaseModel):
    version : Optional[int]
...
class giftcard_style_images_update(BaseModel):
    giftcard_style_id : Optional[ObjectId]
    image : Optional[str]
    default_image_flag : Optional[bool]
...
class merchant_product_terms_update(BaseModel):
    merchant_product_id : Optional[ObjectId]
    terms_text : Optional[str]
    language : Optional[str]
...
class merchant_products_update(BaseModel):
    active : Optional[bool]
    brand_id : Optional[ObjectId]
    giftcard_unit_id : Optional[ObjectId]
...
class variant_values_update(BaseModel):
    active : Optional[bool]
    variant_id : Optional[ObjectId]
...
class offer_orders_update(BaseModel):
    order_status: Optional[str]
    user_id : Optional[ObjectId]
    order_total : Optional[float]
    orderid : Optional[str]
...
# class role_entitlements_update(BaseModel):
#     version : ObjectId
#     role_id : ObjectId
...
class giftcard_varieties_update(BaseModel):
    version : Optional[int]
    active : Optional[bool]
...
class schema_migrations_update(BaseModel):
    version : Optional[str]


class administrator_activity_logs_update(BaseModel):
    version : Optional[int]
    administrator_id : ObjectId
    ip_address : Optional[str]
...
class normalized_addresses_update(BaseModel):
    version : Optional[int]
...
class user_emails_update(BaseModel):
    version : Optional[int]
    user_id : ObjectId
    email : Optional[str]
...
class offer_campaign_transaction_categories_update(BaseModel):
    active : Optional[bool]
